...
class UI_MainWindow(QDialog):
    ...
    def setup_ui(self, parent):
        ...
        self.toggle_btn = PyPushButton(
            text="Menu",
            icon_path=f"{self.ico_path}/icon_menu.svg"
        )
        self.btn_1 = PyPushButton(
            text="Home",
            is_active=True,
            icon_path=f"{self.ico_path}/icon_home.svg",
        )
        self.btn_2 = PyPushButton(
            text="Devices",
            icon_path=f"{self.ico_path}/cil-ci-2.png"
        )
        self.btn_3 = PyPushButton(
            text="Charts",
            icon_path=f"{self.ico_path}/cil-charts-2.png"
        )
        self.btn_4 = PyPushButton(
            text="SCADA",
            icon_path=f"{self.ico_path}/cil-scada-3.png"
        )
        self.btn_5 = PyPushButton(
            text="Open folder",
            icon_path=f"{self.ico_path}/cil-folder.png"
        )
        ...
        self.settings_btn = PyPushButton(
            text="Settings",
            icon_path=f"{self.ico_path}/icon_settings.svg"
        )
